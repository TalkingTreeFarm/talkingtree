<div class="container">
      <div>
            <a href="{{{action('HomeController@homePage')}}}"><img src="/images/logo-navbar.svg" class="img-responsive center-block col-sm-3" alt="Talking Tree Farm" height="75px" width="auto"></a>
      </div>
