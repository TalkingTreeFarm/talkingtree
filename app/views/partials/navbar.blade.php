    ...
    <nav class="navbar">
        <div class="navbar-inner">
            <ul class="nav navbar-nav">
                ...
                <li><a href="/"><img src="/images/logo-navbar.svg" id = "logo" class="img-responsive logo" alt="Talking Tree Farm" ><span class="hide"><img src="/Talking_Tree.ico"</img></span></a><li>
